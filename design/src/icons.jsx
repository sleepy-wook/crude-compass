// Inline icon set — minimal stroke icons (Lucide-style 1.5px stroke)
const Icon = ({ d, size = 16, stroke = "currentColor", fill = "none", sw = 1.6, children, vb = 24 }) => (
...
const I = {
  ...
  Flask:   (p) => <Icon {...p}><path d="M9 3h6M10 3v6L4 19a2 2 0 0 0 1.7 3h12.6A2 2 0 0 0 20 19l-6-10V3"/><path d="M7 14h10"/></Icon>,
  ...
  Bolt:    (p) => <Icon {...p} fill="currentColor" stroke="none"><path d="M13 2L4 14h7l-1 8 9-12h-7z"/></Icon>,
  User:    (p) => <Icon {...p}><circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/></Icon>,
  Ship:    (p) => <Icon {...p}><path d="M3 17a4 4 0 0 0 4-2 4 4 0 0 0 4 2 4 4 0 0 0 4-2 4 4 0 0 0 4 2"/><path d="M5 14l1-5h12l1 5"/><path d="M12 4v5"/></Icon>,
  ...
  Brain:   (p) => <Icon {...p}><path d="M9 3a3 3 0 0 0-3 3v0a3 3 0 0 0-3 3 3 3 0 0 0 1.5 2.6A3 3 0 0 0 6 18a3 3 0 0 0 6 0V3a3 3 0 0 0-3 0z"/><path d="M15 3a3 3 0 0 1 3 3v0a3 3 0 0 1 3 3 3 3 0 0 1-1.5 2.6A3 3 0 0 1 18 18a3 3 0 0 1-6 0"/></Icon>,
  ...
  Send:    (p) => <Icon {...p}><path d="M3 11l18-8-8 18-2-8z"/></Icon>,
  Layers:  (p) => <Icon {...p}><path d="M12 2l10 5-10 5L2 7z"/><path d="M2 12l10 5 10-5M2 17l10 5 10-5"/></Icon>,
  Replay:  (p) => <Icon {...p}><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5"/></Icon>,
