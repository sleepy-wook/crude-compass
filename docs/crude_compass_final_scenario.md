...
→ 백테스트 평균 적중률 75%는 fundamentals + macro 위주 측정. **Leading 신호 (AIS) 통합 시 lead time이 핵심 metric**이 되어야 함.
...
- `llm_backtest_predictions` (backtest 298 rows, 7년 stratified)
...
| 5 | Data Storytelling | **15-17/20** | 호르무즈 진행 중 fact + 양방향 timeline + backtest 298건 75% hit + K-Petroleum 5척 실데이터 lifecycle + Open Data Democratization |
| | **합계** | **82-88/100** 정직 | |
