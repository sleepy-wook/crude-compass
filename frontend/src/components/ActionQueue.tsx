/**
 * ActionQueue — 검토 대기 case priority list (left 5/12 column).
 *
 * 높이는 SelectedCaseDetail과 매칭 — 본문 overflow-y-auto.
 */
...
export function ActionQueue({ cases, selectedId, onSelect }: Props) {
  return (
    <section className="bg-panel border border-line-1 rounded-2xl flex flex-col h-[560px]">
